...
typedef enum slot_status { SLOT_FULL = 0, SLOT_EMPTY = 1 } SLOT_STATUS;
...
int connect_to_server(char *connect_point, char *user_id,
                      int pipe_user_reading_from_server[2],
                      int pipe_user_writing_to_server[2]);
int setup_connection(char *connect_point);
int get_connection(char *user_id, int pipe_child_writing_to_user[2],
